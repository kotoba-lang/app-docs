(ns gen-page
  ...
  kami-app-daw's `scripts/gen-page.cljs`, and app-forms' `cljs/scripts/gen-page.cljs`).
...
(defn page []
  (dds-page/->page
   {:title "docs-performers-r5ycqp6x"
    :description "Docs Performers — AI Agent (reagent + re-frame + jp-go-dds)."
    :lang "ja"
    :css dds-css}
   [:div {:id "app"} "docs-performers-r5ycqp6x loading…"]
